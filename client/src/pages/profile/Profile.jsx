                ...
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                    ...
                    <div className="rounded-lg max-h-[400px]">
                        <div className={`${styles.card} rounded-lg`}>
                            <div className={`bg-green-600 rounded-lg ${styles.cardHeader}`}></div>
                            ...
                            <div className="flex justify-between items-center gap-2 my-6">
                                <button onClick={handleModalOpen} className="rounded border border-green-600 bg-green-600 px-4 py-1.5 text-sm font-medium text-white hover:bg-transparent hover:text-green-600 focus:outline-none focus:ring active:text-green-500">
                                    Update Profile
                                </button>
                            </div>
                        </div>
                            ...
                            <div className="border-b border-gray-200">
                                <nav className="-mb-px flex gap-6">
                                    <Link
                                        ...
                                        className={`shrink-0 border border-transparent p-3 text-sm font-medium ${activeTab === "drivers-license" ? "text-sky-600 border-b-white" : "text-gray-500 hover:text-gray-700"}`}
                                    >
                                        Driver's License
                                    </Link>
                                    <Link
                                        ...
                                        className={`shrink-0 border border-transparent p-3 text-sm font-medium ${activeTab === "current-bookings" ? "text-sky-600 border-b-white" : "text-gray-500 hover:text-gray-700"}`}
                                    >
                                        Current Bookings
                                    </Link>
                                    <Link
                                        ...
                                        className={`shrink-0 border border-transparent p-3 text-sm font-medium ${activeTab === "booking-history" ? "text-sky-600 border-b-white" : "text-gray-500 hover:text-gray-700"}`}
                                    >
                                        Booking History
                                    </Link>
                                </nav>
...
const BookingHistory = ({ bookingHistory }) => {
    return (
        <div className="my-8">
            <h2 className="text-lg font-semibold">{bookingHistory?.length === 0 ? "Booking history is empty" : "Your Booking History"}</h2>
            <div className="my-8">
                            ...
                            <div className="flex justify-between items-start w-full p-5 text-gray-900 bg-white border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-100">
                                <div className="block">
                                    ...
                                    <div className="flex my-2 bg-red-500 p-[2px] rounded-lg text-white w-32">
                                        {
                                            booking?.status === "cancelled" && <p className="mx-auto">{booking?.status}</p>
                                        }
                                    </div>
...
const DriversLicense = ({ driversLicense, customerId }) => {
    ...
    return (
        <div className="my-8 p-4 border rounded-lg shadow-md">
            ...
            <div className="my-4">
                <p><strong>License Number:</strong> {driversLicense?.license_number}</p>
