...
CREATE TABLE IF NOT EXISTS vehicles (
    ...
    category VARCHAR(50) NOT NULL CHECK (category IN ('economy', 'luxury', 'SUV')), 
    status VARCHAR(50) NOT NULL CHECK (status IN ('available', 'booked', 'maintenance', 'out of service')), 
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
